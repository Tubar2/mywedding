...
const WEDDING_DATE = new Date('2026-10-31T15:30:00-03:00')
    ...
    <main className="home">
      <section className="home__hero">
        <div className="home__hero-content">
          ...
          <p className="home__date">31 de outubro de 2026 · 15h30</p>
          <p className="home__local">
            Espaço Araucária Village · Piracaia, SP
          </p>
